...
<div class="row g-3">
	...
	<div class="col-md-6"><label class="form-label">Featured Image</label><input type="file" name="featured_image" class="form-control" accept="image/*">
		@if($blog?->featured_image)<div class="mt-2"><img src="{{ $blog->imageUrl() }}" height="80" class="rounded"></div>@endif
	</div>
