...
<div class="container-fluid">
	...
	<div class="card"><div class="card-body table-responsive">
		<table class="table">
			<thead><tr><th>S.No</th><th>Image</th><th>Title</th><th>Order</th><th>Active</th><th></th></tr></thead>
			<tbody>
			...
			<tr>
				...
				<td class="text-end">
					<div class="table-actions">
						...
						<form action="{{ route('admin.products.destroy', $product) }}" method="POST" onsubmit="return confirm('Delete?')">@csrf @method('DELETE')<button type="submit" class="btn btn-sm btn-outline-danger">Delete</button></form>
					</div>
				</td>
			</tr>
			@empty
		...
		@include('webadmin.partials.table-pagination', ['paginator' => $products])
	</div></div>
</div>
@endsection
