...
<div class="container-fluid">
	...
	<div class="card"><div class="card-body table-responsive">
		<table class="table"><thead><tr><th>Photo</th><th>Name</th><th>Role</th><th>Order</th><th>Active</th><th></th></tr></thead><tbody>
		...
		<tr>
			...
			<td>{{ $member->name }}</td><td>{{ $member->role }}</td><td>{{ $member->sort_order }}</td><td>{{ $member->is_active ? 'Yes' : 'No' }}</td>
